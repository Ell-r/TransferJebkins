...
{
    public class ValidationFilter : IAsyncActionFilter //Перевіряє вхідні запити та наявність створеного валідатора
    {
        //Рефлексія - читання відкомпільованого коду та спрощення його для чогось
                ...
                if (validator is not null)
                {
                    ...
                    if (validateMethod != null)
                    {
                        ...
                        if (isValidProp is false)
                        {
                            ...
                            context.Result = new BadRequestObjectResult(new //Відповідь, яка буде приходити у випадку помилки валідації
                            {
                                //type = "https://tools.ietf.org/html/rfc9110#section-15.5.1",
                                //title = "One or more validation errors occurred.",
                                status = 400, //Статус помилки
                                isValid = false,
                                errors = errorDict, //Список помилок валідації
